...
public class FileUploadProdProperties {
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        final Logger logger = LoggerFactory.getLogger(FileUploadProdProperties.class);
        ...
        if (!CREDENTIALS_FOLDER.exists()) {
            ...
            logger.info("Copy file " + CLIENT_SECRET_FILE_NAME + " into folder above.. and rerun this class!!");
            return;
        }
